...
const Features = () => {
  // Khai báo state để biết khi nào user hover vào box đầu tiên
  const [isHover, setIsHover] = React.useState(false);

  return (
    // Khối tính năng chính với id để điều hướng và căn giữa nội dung
    <div
      id="features"
    ...
    >
      ...
      <Title
        title="Why Choose Our AI Resume Builder?"
        description="Our resume builder is designed to help you create your perfect resume with AI-powered technology."
      />
      {/* Bố cục 2 cột: ảnh & các box tính năng */}
      <div className="flex flex-col md:flex-row items-center justify-center xl:-mt-10">
        ...
        <img
          ...
          alt=""
        />
        {/* Các block tính năng (dùng mouseenter/mouseleave cho box đầu) */}
        <div
          className="px-4 md:px-0"
          onMouseEnter={() => setIsHover(true)}
          onMouseLeave={() => setIsHover(false)}
        >
          {/* Box 1: Analytics, cho hiệu ứng sáng khi không hover */}
          <div
            className={
      ...
      {/* Import font Poppins chỉ áp dụng cho vùng này, override tạm thời */}
      <style>{`
