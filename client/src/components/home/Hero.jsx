...
const Hero = () => {
  // Khai báo state để điều khiển menu di động (menuOpen = true thì hiện menu mobile)
  const [menuOpen, setMenuOpen] = React.useState(false);

  // Mảng logo các công ty đối tác để hiển thị bên dưới hero
  const logos = [
    ...
    <div>
      <div className="min-h-screen pb-20">
        ...
        <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
          ...
          <Link to="/">
            <img src={logo} alt="iResumee Logo" className="h-11 w-auto" />
          </Link>

          {/* Các liên kết menu trên desktop */}
          ...
          {/* Nút tạo mới & đăng nhập trên desktop */}
          ...
          {/* Nút mở menu cho thiết bị di động */}
          <button
        ...
        {/* Menu di động (Mobile Menu) hiển thị khi menuOpen = true */}
        <div
        ...
        <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
          {/* Hiệu ứng đám mây xanh (background orange blur tròn) */}
          ...
          {/* Hiển thị các avatar người dùng + đánh giá sao */}
          <div className="flex items-center mt-24">
            {/* 5 avatar người đã sử dụng */}
          ...
          {/* Tiêu đề nổi bật + nhấn mạnh AI + mô tả ngắn */}
          ...
          <p className="max-w-md text-center text-base my-7">
            Build professional resumes in minutes with our intelligent resume
            builder. Choose from beautiful templates and let AI help you stand
            out.
          </p>

          {/* Hai nút CTA: tạo mới và xem ví dụ */}
          <div className="flex items-center gap-4 ">
            {/* Nút chuyển đến đăng ký tài khoản */}
            <Link
              to="/app?state=register"
            ...
            {/* Nút xem các ví dụ (Hiện demo/video) */}
          ...
          {/* Đoạn nhỏ giới thiệu các thương hiệu/công ty khách hàng tin tưởng */}
          <p className="py-6 text-slate-600 mt-14">
            Trusted by professionals from leading companies
          </p>

          {/* Hiển thị các logo công ty đối tác lớn */}
          <div
      ...
      {/* Import font chữ Poppins từ Google Fonts và set toàn cục */}
      <style>
        {`
